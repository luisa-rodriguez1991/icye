          ...
          <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 md:max-w-2xl md:grid-cols-2 lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-4">
                ...
                <div>
                        <div className='ring-1 ring-indigo-600 rounded-3xl p-4'>
                            ...
                            className='bg-accent-1 text-white shadow-sm hover:bg-accent-2 border border-white mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-white'
                            >
                            Quiero inscrribirme
                            </a>
