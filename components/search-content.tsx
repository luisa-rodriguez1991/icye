...
export default function SearchContent({searchinfo}:any) {
  return (
    ...
    >
      ...
      {searchinfo&&searchinfo.map((result) => (
       

        <li key={result.id} className="relative flex justify-between gap-x-6 px-4 py-5 hover:bg-gray-50 sm:px-6">
          ...
          <div className="flex min-w-0 gap-x-4">
            <div className="min-w-0 flex-auto">
              ...
              <div className="mt-1 flex text-xs leading-5 text-gray-500">
                <div dangerouslySetInnerHTML={{__html:result.excerpt.rendered}} className="relative truncate hover:underline"/>
              </div>
            </div>
          </div>
