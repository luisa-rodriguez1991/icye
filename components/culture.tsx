...
export default function Culture({text, item1, item2, item3, item4,item5, onOpenForm}:any) {
    const intl = useIntl()
            ...
            <div className="basis-12/12 lg:basis-6/12 flex">
                <div className=" flex flex-col ">
                    ...
                    <span className='  bg-gradient-to-r from-accent-1 via-red-400 to-blue-400 inline-block text-transparent bg-clip-text'></span> 
                     <div className="mt-6 text-3xl font-bold tracking-tight text-accent-1 sm:text-4xl" dangerouslySetInnerHTML={{__html: intl.formatMessage({id:"culrute_title"})}} />
                    ...
                    <div className="mt-6 flex items-center gap-x-6">
                        <button  onClick={()=>onOpenForm(true)}  className="z-[999999] lg:z-[0]  fixed top-auto bottom-0 left-0 rounded-[0px] lg:rounded-[40px] w-full lg:static text-center lg:w-auto  lg:min-w-[147px] bg-accent-1 p-4 text-sm font-semibold text-white shadow-sm hover:bg-accent-2 hover:text-accent-1 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
