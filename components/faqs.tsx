      ...
      <div className="bg-white py-24">
         <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
            ...
            {intl.formatMessage({id:"faqs_paragraph+"})}        </p>
        <div className="mx-auto max-w-7xl px-6 mt-10 lg:px-8">
          <div className="">
            <dl className="space-y-16 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-16 sm:space-y-0 lg:grid-cols-3 lg:gap-x-10">
                <div>
                  <dt className="text-md font-semibold leading-7 text-gray-900">Lorem ipsum dolor sit amet consectetur adipisicing elit? </dt>
